                ...
                <div class="tabs-panel is-active" id="new-all" role="tabpanel" aria-hidden="false" aria-labelledby="new-all-label">
                    <div class="row list-group">
                        ...
                        <div class="item large-4 medium-6 columns grid-medium">
                            <div class="post thumb-border post-video" data-user-alias="{{ $v->user->alias or '' }}" data-video-alias="{{ $v->alias }}">
                                ...
                                <div class="post-des">
                                    ...
                                    <div class="post-stats clearfix">
                                        <p class="pull-left">
                                            ...
                                            <span><a href="#">{{ $v->user->name or __('Ai đó') }}</a></span>
                                        </p>
                                        <p class="pull-left">
