...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        @endif
        {{ Form::open(['url' => route('admin.playlist.add'), 
            'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'playlist-edit'
            ]) }}
        <div class="form-group">
            {{ Form::label('user_alias', __('Định danh chủ sở hữu')) }}
            {{ Form::text('user_alias', null, ['class' => 'form-control']) }}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{ Form::select('privacy', [__('Công khai'), __('Không công khai'), __('Riêng tư')], null, ['class' => 'form-control']) }}
        </div>
        <div class="form-group">
